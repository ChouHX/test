$.gf.device_params_define_rt20 = [
    ...
    {title: $lang.SIM_CARD + ' 1', id:'params_tab_sim_card_1', items:[
    ...
    {title: $lang.SIM_CARD + ' 2', id:'params_tab_sim_card_2', items:[
        {name:'apn2',        label:'APN', length:[0,63]},
        {name:'ppp_name2',   label:'APN '+$lang.VAR_USER_NAME, length:[0,63]},
        {name:'ppp_pw2',     label:'APN '+$lang.VAR_PASSWD, length:[0,63]},
        {name:'auth_mode2',  label:$lang.AUTH_TYPE, xtype:'combo', data:[
            {id:'0', name:'AUTO'},
            {id:'1', name:'PAP'},
            {id:'2', name:'CHAP'}
        ]},
        {name:'main_dns2',   label:$lang.WAN_DNS, regex:$.gf.reg_ip, regexText:$lang.VAR_TERM_PARAM_CORRECT_IP},
        {name:'sec_dns2',    label:$lang.WAN_DNS2, regex:$.gf.reg_ip, regexText:$lang.VAR_TERM_PARAM_CORRECT_IP},
        {name:'pin_code2',   label:$lang.PIN_CODE, length:[4,4]},
        {name:'network_mode2',  label:$lang.NET_MODE, xtype:'combo', data:[
            {id:'0', name:'AUTO'},
            {id:'1', name:'4G'},
            {id:'2', name:'3G'},
            {id:'3', name:'2G_3G'},
    ...
    {title: $lang.OSMOMETER, id:'params_tab_osmometer', items:[
        ...
        {name:'om_ctype_1',     label:$lang.CHANNEL_1+'&nbsp;'+$lang.VAR_TYPE, xtype:'combo', data:[{id:'0', name:$lang.OSMOMETER},{id:'1', name:$lang.SEDIMENTATION_METER}]},
        ...
        {name:'om_r1_1',        label:$lang.CHANNEL_1+'&nbsp;'+'r1', hidden:true},
        {name:'om_r2_1',        label:$lang.CHANNEL_1+'&nbsp;'+'r2', hidden:true},
        {name:'om_enable_2',    label:$lang.CHANNEL_2+'&nbsp;'+$lang.VAR_ENABLE,  xtype:'checkbox', hidden:true},
        {name:'om_ctype_2',     label:$lang.CHANNEL_2+'&nbsp;'+$lang.VAR_TYPE, xtype:'combo', data:[{id:'0', name:$lang.OSMOMETER},{id:'1', name:$lang.SEDIMENTATION_METER}]},
        ...
        {name:'om_r1_2',        label:$lang.CHANNEL_2+'&nbsp;'+'r1', hidden:true},
        {name:'om_r2_2',        label:$lang.CHANNEL_2+'&nbsp;'+'r2', hidden:true},
        {name:'om_enable_3',    label:$lang.CHANNEL_3+'&nbsp;'+$lang.VAR_ENABLE,  xtype:'checkbox', hidden:true},
        {name:'om_ctype_3',     label:$lang.CHANNEL_3+'&nbsp;'+$lang.VAR_TYPE, xtype:'combo', data:[{id:'0', name:$lang.OSMOMETER},{id:'1', name:$lang.SEDIMENTATION_METER}]},
        ...
        {name:'om_r1_3',        label:$lang.CHANNEL_3+'&nbsp;'+'r1', hidden:true},
        {name:'om_r2_3',        label:$lang.CHANNEL_3+'&nbsp;'+'r2', hidden:true},
        {name:'om_enable_4',    label:$lang.CHANNEL_4+'&nbsp;'+$lang.VAR_ENABLE,  xtype:'checkbox', hidden:true},
        {name:'om_ctype_4',     label:$lang.CHANNEL_4+'&nbsp;'+$lang.VAR_TYPE, xtype:'combo', data:[{id:'0', name:$lang.OSMOMETER},{id:'1', name:$lang.SEDIMENTATION_METER}]},
        ...
        {name:'om_r1_4',        label:$lang.CHANNEL_4+'&nbsp;'+'r1', hidden:true},
        {name:'om_r2_4',        label:$lang.CHANNEL_4+'&nbsp;'+'r2', hidden:true}
    ]},
    {title: $lang.INCLINOMETER, id:'params_tab_inclinometer', items:[
        ...
        {name:'cl_uart_x',      label:$lang.CONNECT_SERIAL_PORT, xtype:'combo', data:[
            {id:'0', name:'485-1'},
            {id:'1', name:'485-2'}
        ]},
        {name:'cl_baudrate',    label:$lang.IBST_SERIAL_RATE, xtype:'combo', data:[
            {id:'1200', name:'1200'},
            {id:'2400', name:'2400'},
            {id:'4800', name:'4800'},
            {id:'9600', name:'9600'},
        ...
        {name:'cl_databit',     label:$lang.IBST_SERIAL_DATABITS,   xtype:'combo', data:[{id:'7', name:'7'}, {id:'8', name:'8'}]},
        {name:'cl_stopbit',     label:$lang.IBST_SERIAL_STOPBITS,   xtype:'combo', data:[{id:'1', name:'1 '+$lang.IBST_SERIAL_STOPBITS}, {id:'2', name:'2 '+$lang.IBST_SERIAL_STOPBITS}]},
        {name:'cl_paritybit',   label:$lang.IBST_SERIAL_PARITY,     xtype:'combo', data:[{id:'0', name:$lang.VAR_NONE}, {id:'1', name:$lang.VAR_ODD}, {id:'2', name:$lang.VAR_EVEN}]},
        ...
        {name:'cl_offset_x5',   label:'5# '+$lang.RETURN_ZERO+' X', xtype:'number'},
        {name:'cl_offset_y5',   label:'5# '+$lang.RETURN_ZERO+' Y', xtype:'number'}
    ]},
    {title: $lang.POSITIONING_PARAMETER, id:'params_tab_position_parameter', items:[
        ...
        {name:'ns_hw_type',             label:$lang.HARDWARE_TYPE, xtype:'combo', data:[{id:'0', name:'S'}, {id:'1', name:'F'}, {id:'2', name:'U'}]},
