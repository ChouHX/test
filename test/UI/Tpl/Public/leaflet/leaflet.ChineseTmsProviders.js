...
L.TileLayer.ChinaProvider.providers = {
    ...
    GaoDe: {
        Normal: {
			...
			// Map: '//map.geoq.cn/ArcGIS/rest/services/ChinaOnlineCommunity/MapServer/tile/{z}/{y}/{x}' //arcgis在线地图
        },
        Satellite: {
    ...
    Google: {
        Normal: {
            Map: "//mt3.google.com/maps/vt?lyrs=m@189&gl=en&x={x}&y={y}&z={z}"
        },
        Satellite: {
            Map: "//mt3.google.com/maps/vt?lyrs=s@189&gl=en&x={x}&y={y}&z={z}",
            Annotion: "//mt3.google.com/maps/vt?lyrs=y@189&gl=en&x={x}&y={y}&z={z}"
        },
        Subdomains: []
    },
    ...
    Google_cn: {
        ...
        Normal: {
            Map: "//mt3.google.cn/maps/vt?lyrs=m@189&gl=cn&x={x}&y={y}&z={z}"
        },
        Satellite: {
            Map: "//mt3.google.cn/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}",
            Annotion: "//mt3.google.cn/maps/vt?lyrs=y@189&gl=cn&x={x}&y={y}&z={z}"
        },
        Subdomains: []
    },
