...
<link rel="stylesheet" type="text/css" rel="stylesheet" type="text/css" href="../Public/bootstrap_validator/bv.min.css?rand=<?php echo (CACHE_VERSION); ?>">
<link rel="stylesheet" type="text/css" rel="stylesheet" type="text/css" href="__ROOT__/Tpl/Syscfg/grzx.css?rand=<?php echo (CACHE_VERSION); ?>">
<!--jqGrid-->
    ...
    <section class="content padding-top-0">
        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo (L("USR_BASIC_INFO")); ?></h3>
            </div>
            <div class="box-body">
              <div class="my-loading"></div><!--loading div-->
              <table class="table table-bordered tbl-params" id="tbl-params" style="position: relative;">
                <tr>
                  <th rowspan="4" class="th-head-container">
                    <img src="../../Upload/headimg/<?php echo ($row['head']); ?>" title="<?php echo (L("HEAD_IMG")); ?>" class="user-head-img-edit">
                  </th>
                  <th width="200px"><?php echo (L("VAR_USER_NAME")); ?>：</th>
                  <td><?php echo ($row['name']); ?></td>
                  <th width="200px"><?php echo (L("VAR_USER_TYPE")); ?>：</th>
                  <td><?php echo ($row['usr_type_text']); ?></td>
                </tr>
                <tr>
                  <th><?php echo (L("VAR_CMD_CREATETIME")); ?>：</th>
                  <td><?php echo ($row['create_time']); ?></td>
                  <th><?php echo (L("EXPIRED_TIME")); ?>：</th>
                  <td><?php echo ($row['expired_time']); ?></td>
                </tr>
                <tr>
                  <th><?php echo (L("VAR_DEVICE_EMAIL")); ?>：</th>
                  <td class="td-input"><input type="text" name="email" value="<?php echo ($row['email']); ?>"><i class="fa fa-pencil"></i></td>
                  <th><?php echo (L("MOBILE_NUMBER")); ?>：</th>
                  <td class="td-input"><input type="text" name="sim" value="<?php echo ($row['sim']); ?>"><i class="fa fa-pencil"></i></td>
                </tr>
                <tr>
                  <th><?php echo (L("VAR_NOTE")); ?>：</th>
                  <td colspan="1" class="td-input"><input type="text" name="info" value="<?php echo ($row['info']); ?>"><i class="fa fa-pencil"></i></td>
                  <th><?php echo (L("VAR_OPERATION")); ?>：</th>
                  <td>
                    <div class="toolbar">
                      <button type="button" class="btn btn-default btn-xs" id="btn_edit_basic">&nbsp;<?php echo (L("SAVE_TEMPLATE")); ?></button>&nbsp;&nbsp;
                      <button type="button" class="btn btn-default btn-xs" id="btn_edit_pass">&nbsp;<?php echo (L("VAR_EDIT_PASS")); ?></button>
                    </div>
                  </td>
                </tr>
              </table>
              <!--
              <div class="toolbar" style="text-align: right; padding-right: 10px; margin-top: 10px;">
                <button type="button" class="btn btn-default btn-sm" id="btn_edit_pass"><span class="fa fa-pencil">&nbsp;<?php echo (L("VAR_EDIT_PASS")); ?></span></button>&nbsp;&nbsp;
                <button type="button" class="btn btn-default btn-sm" id="btn_edit_basic"><span class="fa fa-save">&nbsp;<?php echo (L("SAVE_TEMPLATE")); ?></span></button>
              </div>
              -->
            </div>
          </div>
      ...
      <div class="row" style="margin-top: 15px;">
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo (L("USR_LOGIN_HISTORY")); ?></h3>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo (L("HEAD_IMG_EDIT")); ?></h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success save_edit_headimg"><?php echo (L("VAR_BTN_SURE")); ?></button>
...
<script type="text/javascript" src="__ROOT__/Tpl/Syscfg/grzx.js?rand=<?php echo (CACHE_VERSION); ?>"></script>