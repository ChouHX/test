    ...
    <section class="content padding-top-0">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs" id="tab_params_list">
          <li class="active"><a href="#params_tab_1" data-toggle="tab"><?php echo (L("VAR_TG")); ?></a></li>
          <?PHP if ($_SESSION[C('SESSION_NAME')]['name'] == 'admin') { ?>
          <li><a href="#params_tab_2" data-toggle="tab" data-init="0"><?php echo (L("VAR_TG_RULE")); ?></a></li>
          <?PHP } ?>
        </ul>
            ...
            <div class="btn-toolbar" role="toolbar" style="margin: 0 0 15px; width: 100%">
              <form class="form-inline" role="form" id="search_fm">
                <div class="btns">
                  ...
                  <button type="button" class="btn btn-default" onclick="javascript:$('#list2').trigger('reloadGrid');">
                    <i class="fa fa-refresh"></i>&nbsp;<?php echo (L("VAR_REFRESH")); ?>
                  </button>
                </div>
                <div class="input-group">
                  <input type="text" name="searchString" class="form-control" placeholder="<?php echo (L("VAR_QUERY")); ?>" style="width: 130px" data-toggle="tooltip"  title="<?php echo (L("GROUP_NAME")); ?>">
                  <span class="input-group-btn">
          ...
          <div class="tab-pane" id="params_tab_2">
            <div class="btn-toolbar" role="toolbar" style="margin: 0 0 15px; width: 100%">
              <form class="form-inline" role="form" id="search_fm2">
                <div class="btns">
                  <button type="button" class="btn btn-default rwcs" data-act="add_rule">
                    <i class="fa fa-plus"></i>&nbsp;<?php echo (L("VAR_ADD")); ?>
                  </button>
                  <button type="button" class="btn btn-default rwcs" data-act="edit_rule">
                    <i class="fa fa-pencil"></i>&nbsp;<?php echo (L("VAR_EDIT")); ?>
                  </button>
                  <button type="button" class="btn btn-default rwcs" data-act="del_rule">
                    <i class="fa fa-close"></i>&nbsp;<?php echo (L("VAR_DEL")); ?>
                  </button>
                  <button type="button" class="btn btn-default rwcs" data-act="exec_rule">
                    <i class="fa fa-bug"></i>&nbsp;<?php echo (L("RULE_EXEC")); ?>
                  </button>
                  <button type="button" class="btn btn-default" onclick="javascript:$('#list3').trigger('reloadGrid');">
                    <i class="fa fa-refresh"></i>&nbsp;<?php echo (L("VAR_REFRESH")); ?>
                  </button>
                </div>
              </form>
            ...
            <div id="pager3" style="margin-top: 5px !important;"></div>
          </div>
          <?PHP } ?>
        </div>
      </div>
...
<script type="text/javascript" src="__ROOT__/Tpl/Term/fzlb.js?rand=<?php echo (CACHE_VERSION); ?>"></script>