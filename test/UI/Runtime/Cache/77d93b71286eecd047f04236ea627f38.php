        ...
        <div class="col-md-12">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo (L("VAR_MENU_USER_LIST")); ?></h3>
            </div>
            <div class="box-body jqgrid_c">
              <div class="btn-toolbar" role="toolbar" style="margin: 0 0 15px; width: 100%">
                <form class="form-inline" role="form" id="search_fm">
                  ...
                  <div class="input-group">
                    <input type="text" name="searchString" class="form-control" placeholder="<?php echo (L("VAR_QUERY")); ?>" style="width: 130px" data-toggle="tooltip"  title="<?php echo (L("VAR_USER_NAME")); ?>">
                    <span class="input-group-btn">
...
<script>$.gf.usr_ps_def = <?php echo ($page_nodes); ?>;</script>
<script type="text/javascript" src="__ROOT__/Tpl/Syscfg/yhlb.js?rand=<?php echo (CACHE_VERSION); ?>"></script>