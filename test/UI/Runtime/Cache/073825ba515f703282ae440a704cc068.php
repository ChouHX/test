...
<link rel="stylesheet" type="text/css" href="__ROOT__/Tpl/Rtu/card.css?rand=<?php echo (CACHE_VERSION); ?>">
        ...
        <div class="col-md-12">
          <div class="box box-solid">
            ...
            <div class="box-header with-border" style="padding-bottom: 0">
              <ul id="ul_tg">
              <?PHP
 $back_gid = $_REQUEST['gid'] ? $_REQUEST['gid'] : -10; array_unshift($groups, array('id'=>-10, 'name'=>L('VAR_ALL_DEVICE'))); array_push($groups, array('id'=>-100, 'name'=>'...')); foreach ($groups as $k=>$row){ $btn_str = '<button class="btn btn-'.($row['id']==$back_gid?'info':'default').'" data-gid="'.$row['id'].'">'.$row['name'].'</button>'; if ($row['id'] == -10){ $btn_str = '<div class="button-group">'.$btn_str.'<button type="button" class="btn btn-default btn-toggle" title="'.L('VAR_EXPAND').'"><i class="fa fa-caret-down"></i></button></div>'; } echo '<li title="'.($row['id']==-100?L('VAR_MORE'):'').'">'.$btn_str.'</li>'; }?>
              </ul>
            </div> -->
            <div class="box-body">
              <div class="nav-tabs-custom" style="box-shadow: none">
                <ul class="nav nav-tabs" id="tab_device_list">
                  <li>
                    <button type="button" class="btn btn-info" title="<?php echo (L("VAR_EXPAND")); ?>" id="change_gid" style="margin: 0 10px 0 10px;">
                      <span data-id="-10"><?php echo (L("VAR_ALL_DEVICE")); ?></span>&nbsp;<i class="fa fa-caret-down"></i>
                    </button>
                  </li>
                  <li class="active"><a href="#tab_2" data-toggle="tab"><?php echo (L("LIST_SHOW")); ?></a></li>
                  <li><a href="#tab_1" data-toggle="tab"><?php echo (L("CARD_SHOW")); ?></a></li>
                </ul>
                  ...
                  <div class="tab-pane jqgrid_c" id="tab_1" style="position: relative;">
                    ...
                    <div class="btn-toolbar" role="toolbar" style="margin: 0 0 15px; width: 100%">
                      <form class="form-inline" role="form" id="search_fm">
                        <div class="btns">
                          <button type="button" class="btn btn-default refresh-jqgrid" title="<?php echo (L("VAR_REFRESH")); ?>" data-index="1">
                    ...
                    <div class="btn-toolbar" role="toolbar" style="margin: 0 0 15px; width: 100%">
                      <form class="form-inline" role="form" id="search_fm2">
                        <div class="btns">
                          ...
                          <button type="button" class="btn btn-default rwcs project-config" title="<?php echo (L("PROJECT_CONFIGURATION")); ?>">
                            <i class="fa fa-cogs"></i>&nbsp;<?php echo (L("PROJECT_CONFIGURATION")); ?>
                          </button>
                          <button type="button" class="btn btn-default rwcs sensor-custom" title="<?php echo (L("THRESHOLD_SETTING")); ?>">
                            <i class="fa fa-pencil-square-o"></i>&nbsp;<?php echo (L("THRESHOLD_SETTING")); ?>
                          </button>
                          <?PHP } ?>
                          <button type="button" class="btn btn-default rwcs export-excel" title="<?php echo (L("VAR_DEVICE_EXPORT_EXCEL")); ?>">
                            <i class="fa fa-file-excel-o"></i>&nbsp;<?php echo (L("VAR_DEVICE_EXPORT_EXCEL")); ?>
                          </button>
                          <?PHP if ($oem == 'HUARUN' || $oem == 'WANKE'){ ?>
                          <button type="button" class="btn btn-default rwcs re-report-info" title="<?php echo (L("REPORT_CONFIGURATION_AGAIN")); ?>">
                            <i class="fa fa-cloud-upload"></i>&nbsp;<?php echo (L("REPORT_CONFIGURATION_AGAIN")); ?>
                          </button>
                          <?PHP } ?>
                          <button type="button" class="btn btn-default refresh-jqgrid" title="<?php echo (L("VAR_REFRESH")); ?>" data-index="2">
                            <i class="fa fa-refresh"></i>&nbsp;<?php echo (L("VAR_REFRESH")); ?>
                          </button>
                        </div>
                        <div class="input-group">
                        ...
                        <button type="button" class="btn btn-default" id="btn_set_columns" title="<?php echo (L("VAR_CFG_FIELDS")); ?>" style="margin-left: 10px">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo (L("SENSOR_TYPE")); ?></h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-info btn-sensor-custom"><?php echo (L("VAR_UPDATE")); ?></button>
                <button type="button" class="btn btn-success btn-sensor-custom-submit" style="display: none;"><?php echo (L("VAR_BTN_SUBMIT")); ?></button>
                <!-- <button type="button" class="btn btn-warning btn-sensor-reset"><?php echo (L("VAR_BTN_RESET")); ?></button> -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form class="form-horizontal" id="modal_fm_grid_columns">
                <ul><!-- <li><input type="checkbox" name="columns"><span><?php echo (L("VAR_TERM_STATUS")); ?></span></li> --></ul>
              </form>
          </div>
          <div class="modal-footer">
...
<script type="text/javascript" src="../Public/highcharts/highstock.js?rand=<?php echo (CACHE_VERSION); ?>"></script>
<script type="text/javascript" src="../Public/highcharts/no-data-to-display.js?rand=<?php echo (CACHE_VERSION); ?>"></script>
<script type="text/javascript" src="../Public/highcharts/theme/sand-signika.js?rand=<?php echo (CACHE_VERSION); ?>"></script>
<!--map-->
...
<script type="text/javascript">
$.gf.sensors = <?php echo ($sensors); ?>;
$.gf.oem = "<?php echo ($oem); ?>";
</script>
<script type="text/javascript" src="__ROOT__/Tpl/Rtu/card.js?rand=<?php echo (CACHE_VERSION); ?>"></script>
<script type="text/javascript" src="__ROOT__/Tpl/Rtu/lora.js?rand=<?php echo (CACHE_VERSION); ?>"></script>