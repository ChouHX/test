<!--
--><title><%translate("Network Tools");%>: <%translate("Trace Route");%></title>
...
<content>
	...
	<ul class="nav-tabs">
		...
		<li><a class="active"><i class="icon-gauge"></i> <%translate("Trace");%></a></li>
	...
	<div class="box">
		...
		<div class="content">
			...
			<script type="text/javascript">
				$('#tracert-form').forms([
				{ title: '<%translate("IP Address");%>', name: 'f_addr', type: 'text', maxlen: 64, size: 32, value: '', suffix: ' <input type="button" value="<%translate("Trace");%>" onclick="trace()" id="traceb">' },
