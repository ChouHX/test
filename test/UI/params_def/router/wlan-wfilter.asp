...
--><title><% ident(); %> <%translate("WLAN");%>: <%translate("Wireless Filter");%></title>
<content>
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box">
			<div class="heading"><%translate("Wireless Client Filter");%></div>
			<div class="content">
				...
				&nbsp;
				<div class="radio c-radio"><label><input type="radio" name="f_type" id="_f_deny" value="deny"><span class="icon-check"></span><%translate("Block the following clients");%></label></label></div>
