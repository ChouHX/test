...
//			}
			if(i == 'usb0' || i == 'usb1' || i == 'ppp0' || i == "ppp1")
			{
				t = 'Cellular <small>(' + i + ')</small>';
			}
			else if(i.indexOf("ppp10") != -1)//vpn接口是从ppp101开始的
			{
				t = 'VPN <small>(' + i + ')</small>';			
			}
			else if(i == 'ra0' || i == 'ra1' || i == 'ra2'|| i == 'ra3')
			{
				var wname = wl_display_ifname(0);

				if(wname.indexOf("5") != -1)
				{
					t = 'Wi-Fi/5G <small>(' + i + ')</small>';
				}
				else
				{
					
					t = 'Wi-Fi/2.4G <small>(' + i + ')</small>';
				}
			}
			else if(i == 'rai0' || i == 'rai1' || i == 'rai2'|| i == 'rai3')
			{
				var wname = wl_display_ifname(1);
			...
			else if(i == 'br0' || i == 'br1' || i == 'br2' || i == 'br3')
			{
				t = 'LAN <small>(' + i + ')</small>';
			}
			else if(i == nvram.wan_ifnameX)
			{
				t = 'WAN <small>(' + i + ')</small>';
			}
			else
...
//			/* MULTIWAN-END */
//			) {
//				if ( nvram.wan_iface == i ) t = 'Cellular1 <small>(' + i + ')</small>';
//				else if ( nvram.wan2_iface == i ) t = 'Cellular2 <small>(' + i + ')</small>';
//				/* MULTIWAN-BEGIN */
