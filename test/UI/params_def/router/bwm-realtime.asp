...
<content>
	...
	<script type="text/javascript">
		//<% nvram("wan_ifnameX,wan_ifname,wan_iface,wan2_ifname,wan2_iface,wan3_ifname,wan3_iface,wan4_ifname,wan4_iface,lan_ifname,wl_ifname,wan_proto,wan2_proto,wan3_proto,wan4_proto,web_svg,rstats_colors"); %>
		...
		<div class="content">
			<div id="rstats">
				...
				<div id="bwm-controls">
					...
					<a href="javascript:switchDraw(0)" id="draw1"><%translate("Line");%></a>
