...
<html lang="en">
	<head>
		...
		<title>[<% ident(); %>] <% translate("Upgrading"); %>...</title>
		<style>
			body {
		...
		<script type="text/javascript">
			...
			function tick()
			{
				...
				if (n == Max) c.style.display = 'block';
	...
	<body>
		<div style="width:100%; max-width: 600px; margin: 10% auto; text-align: center;">
			<div style='width:90%; margin:5px auto;padding:5px 5%;'>
				<span id="msg"></span><br /><span id="re"><div class="spinner"></div> <b><% translate("MCU fireware has been upgraded success"); %>...</b></span><br />
