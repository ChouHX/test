<!--
--><title> <%translate("IP Traffic: Daily History");%></title>
<content>
	<style type="text/css">
		#daily-grid .co3,
		#daily-grid .co4,
	...
	<div id="cstats" class="box">
		<div class="heading"><%translate("Daily IP Traffic");%> <a class="pull-right" href="#" data-toggle="tooltip" title="Reload Information" onclick="reloadPage(); return false;"><i class="icon-refresh"></i></a></div>
		<div class="content">
	...
	<script type="text/javascript">
		...
		c.push({ title: '<%translate("Date Format");%>', name: 'f_dafm', type: 'select', options: [['0', '<%translate("yyyy-mm-dd");%>'], ['1', '<%translate("mm-dd-yyyy");%>'], ['2', '<%translate("mmm dd, yyyy");%>'], ['3', '<%translate("dd.mm.yyyy");%>']] });
