...
<content>
	...
	<ul class="nav-tabs">
		...
		<li><a class="active"><i class="icon-cmd"></i><%translate("System Commands");%></a></li>
	...
	<div class="box">
		<div class="heading"><%translate("System Shell");%></div>
		<div class="content">
			...
			<script type="text/javascript">
				$('#command-form').forms([
					{ title: '<%translate("Command");%>', help:'<%translate("Use the command");%> &quot;nvram export --set&quot; or &quot;nvram export --set | grep qos&quot; <%translate("to cut and paste configuration");%>',
	...
	<div id="refresh"></div><button type="button" value="Execute" onclick="execute()" id="execb" class="btn"><%translate("Execute");%> <i class="icon-cmd"></i></button>
