<!--
--><title> <%translate("IP Traffic: Monthly History");%></title>
<content>
	<style type="text/css">
		#monthly-grid .co3,
		#monthly-grid .co4,
	...
	<div id="cstats" class="box">
		<div class="heading"><%translate("Monthly IP Traffic");%> <a class="pull-right" href="#" data-toggle="tooltip" title="<%translate("Reload Information");%>" onclick="reloadPage(); return false;"><i class="icon-refresh"></i></a></div>
		<div class="content">
...
<!--	<a href="javascript:genData()" class="btn btn-primary"><%translate("Data");%> <i class="icon-drive"></i></a>
	...
	<script type="text/javascript">
		...
		c.push({ title: '<%translate("Date Format");%>', name: 'f_dafm', type: 'select', options: [['0', '<%translate("yyyy-mm");%>'], ['1', '<%translate("mm-yyyy");%>");%>'], ['2', '<%translate("mmm, yyyy");%>'], ['3', '<%translate("mm.yyyy");%>']] });
