<!--
--><title><%translate("VPN Tunnel");%>: <%translate("PPTP/L2TP Online");%></title>
<content>
	<style type="text/css">
		#dev-grid .co1 {
			width: 10%;
	...
	<script type="text/javascript">
		...
		dg.setup = function() {
			...
			this.headerSet(['<%translate("Interface");%>', '<b><%translate("Username");%>', '<%translate("Online Since");%>', '<%translate("VPN IP Address");%>', '<%translate("Source IP Address");%>', '<%translate("Action");%>']);
			this.populate();
			this.sort(1);
		}
